...
import org.example.currencyrateclient.config.CbrRateClientConfig;
import org.example.currencyrateclient.config.TkfRateClientConfig;
...
@Slf4j
public class TkfRateClient implements RateClient {
    public static final String DATE_FORMAT = "dd-MM-yyyy";
    private static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ofPattern(DATE_FORMAT);

    private final TkfRateClientConfig config;
